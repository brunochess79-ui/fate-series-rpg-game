...
const arthur: ServantDefinition = {
  ...
  wikiUrl: "https://en.wikipedia.org/wiki/King_Arthur",
  maxHp: 1140,
  atk: 105,
  def: 81,
  agility: 70,
...
const siegfried: ServantDefinition = {
  ...
  className: 'Saber',
  trueName: 'Siegfried',
  wikiUrl: "https://en.wikipedia.org/wiki/Siegfried",
  maxHp: 1210,
  atk: 110,
  def: 76,
  agility: 65,
...
const elCid: ServantDefinition = {
  ...
  wikiUrl: "https://en.wikipedia.org/wiki/El_Cid",
  maxHp: 1190,
  atk: 103,
  def: 84,
  agility: 55,
...
const altera: ServantDefinition = {
  ...
  wikiUrl: "https://en.wikipedia.org/wiki/Attila",
  maxHp: 1200,
  atk: 130,
  def: 60,
  agility: 65,
...
const sengoMuramasa: ServantDefinition = {
  ...
  wikiUrl: "https://en.wikipedia.org/wiki/Muramasa",
  maxHp: 1000,
  atk: 121,
  def: 55,
  agility: 70,
...
const mordred: ServantDefinition = {
  ...
  className: 'Saber',
  trueName: 'Mordred',
  wikiUrl: "https://en.wikipedia.org/wiki/Mordred",
  maxHp: 1150,
  atk: 125,
  def: 58,
  agility: 68,
...
const yagyuMunenori: ServantDefinition = {
  ...
  wikiUrl: "https://en.wikipedia.org/wiki/Yagy%C5%AB_Munenori",
  maxHp: 1050,
  atk: 120,
  def: 62,
  agility: 72,
...
const nero: ServantDefinition = {
  ...
  wikiUrl: "https://en.wikipedia.org/wiki/Nero",
  maxHp: 1100,
  atk: 110,
  def: 58,
  agility: 60,
...
const okitaSouji: ServantDefinition = {
  ...
  wikiUrl: "https://en.wikipedia.org/wiki/Okita_S%C5%8Dji",
  maxHp: 950,
  atk: 132,
  def: 52,
  agility: 88,
...
const gawain: ServantDefinition = {
  ...
  className: 'Saber',
  trueName: 'Gawain',
  wikiUrl: "https://en.wikipedia.org/wiki/Gawain",
  maxHp: 1450,
  atk: 115,
  def: 85,
  agility: 55,
...
const richard: ServantDefinition = {
  ...
  className: 'Saber',
  trueName: 'Richard I',
  wikiUrl: "https://en.wikipedia.org/wiki/Richard_I_of_England",
  maxHp: 1150,
  atk: 118,
  def: 62,
  agility: 62,
...
const charlemagne: ServantDefinition = {
  ...
  wikiUrl: "https://en.wikipedia.org/wiki/Charlemagne",
  maxHp: 1150,
  atk: 112,
  def: 65,
  agility: 58,
...
const saito: ServantDefinition = {
  ...
  wikiUrl: "https://en.wikipedia.org/wiki/Sait%C5%8D_Hajime",
  maxHp: 1100,
  atk: 100,
  def: 62,
  agility: 70,
