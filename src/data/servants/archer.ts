...
const gilgamesh: ServantDefinition = {
  ...
  className: 'Archer',
  trueName: 'Gilgamesh',
  fateWikiUrl: "https://fategrandorder.fandom.com/wiki/Gilgamesh",
  maxHp: 1090,
  atk: 125,
  def: 60,
  agility: 65,
...
const emiya: ServantDefinition = {
  ...
  fateWikiUrl: "https://fategrandorder.fandom.com/wiki/EMIYA",
  maxHp: 1000,
  atk: 113,
  def: 60,
  agility: 80,
...
const orion: ServantDefinition = {
  ...
  className: 'Archer',
  trueName: 'Orion',
  fateWikiUrl: "https://fategrandorder.fandom.com/wiki/Super_Orion",
  maxHp: 1200,
  atk: 128,
  def: 70,
  agility: 60,
...
const tametomo: ServantDefinition = {
  ...
  fateWikiUrl: "https://fategrandorder.fandom.com/wiki/Minamoto_no_Tametomo",
  maxHp: 1300,
  atk: 128,
  def: 60,
  agility: 45,
...
const ishtar: ServantDefinition = {
  ...
  className: 'Archer',
  trueName: 'Ishtar',
  fateWikiUrl: "https://fategrandorder.fandom.com/wiki/Ishtar",
  maxHp: 1150,
  atk: 119,
  def: 58,
  agility: 62,
...
const moriarty: ServantDefinition = {
  ...
  fateWikiUrl: "https://fategrandorder.fandom.com/wiki/James_Moriarty",
  maxHp: 1150,
  atk: 113,
  def: 58,
  agility: 68,
