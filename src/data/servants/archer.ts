...
const arash: ServantDefinition = {
  ...
  className: 'Archer',
  trueName: 'Arash',
  wikiUrl: "https://en.wikipedia.org/wiki/Arash",
  maxHp: 980,
  atk: 100,
  def: 58,
  agility: 85,
...
const robinHood: ServantDefinition = {
  ...
  className: 'Archer',
  trueName: 'Robin Hood',
  wikiUrl: "https://en.wikipedia.org/wiki/Robin_Hood",
  maxHp: 950,
  atk: 100,
  def: 53,
  agility: 88,
...
const williamTell: ServantDefinition = {
  ...
  wikiUrl: "https://en.wikipedia.org/wiki/William_Tell",
  maxHp: 920,
  atk: 98,
  def: 48,
  agility: 75,
...
const atalanta: ServantDefinition = {
  ...
  className: 'Archer',
  trueName: 'Atalanta',
  wikiUrl: "https://en.wikipedia.org/wiki/Atalanta",
  maxHp: 990,
  atk: 96,
  def: 55,
  agility: 105,
...
const gilgamesh: ServantDefinition = {
  ...
  className: 'Archer',
  trueName: 'Gilgamesh',
  wikiUrl: "https://en.wikipedia.org/wiki/Gilgamesh",
  maxHp: 1090,
  atk: 125,
  def: 60,
  agility: 65,
...
const orion: ServantDefinition = {
  ...
  className: 'Archer',
  trueName: 'Orion',
  wikiUrl: "https://en.wikipedia.org/wiki/Orion_(mythology)",
  maxHp: 1200,
  atk: 128,
  def: 70,
  agility: 60,
...
const tametomo: ServantDefinition = {
  ...
  wikiUrl: "https://en.wikipedia.org/wiki/Minamoto_no_Tametomo",
  maxHp: 1300,
  atk: 128,
  def: 60,
  agility: 45,
...
const ishtar: ServantDefinition = {
  ...
  className: 'Archer',
  trueName: 'Ishtar',
  wikiUrl: "https://en.wikipedia.org/wiki/Ishtar",
  maxHp: 1150,
  atk: 119,
  def: 58,
  agility: 62,
...
const ashwatthama: ServantDefinition = {
  ...
  wikiUrl: "https://en.wikipedia.org/wiki/Ashvatthama",
  maxHp: 1150,
  atk: 108,
  def: 60,
  agility: 62,
...
const moriarty: ServantDefinition = {
  ...
  wikiUrl: "https://en.wikipedia.org/wiki/Professor_Moriarty",
  maxHp: 1150,
  atk: 113,
  def: 58,
  agility: 68,
