...
const iskandar: ServantDefinition = {
  ...
  className: 'Rider',
  trueName: 'Iskandar',
  wikiUrl: "https://en.wikipedia.org/wiki/Alexander_the_Great",
  maxHp: 1330,
  atk: 100,
  def: 75,
  agility: 60,
...
const bellerophon: ServantDefinition = {
  ...
  wikiUrl: "https://en.wikipedia.org/wiki/Bellerophon",
  maxHp: 1140,
  atk: 100,
  def: 68,
  agility: 95,
...
const boudica: ServantDefinition = {
  ...
  className: 'Rider',
  trueName: 'Boudica',
  wikiUrl: "https://en.wikipedia.org/wiki/Boudica",
  maxHp: 1280,
  atk: 98,
  def: 78,
  agility: 58,
...
const marcoPolo: ServantDefinition = {
  ...
  className: 'Rider',
  trueName: 'Marco Polo',
  wikiUrl: "https://en.wikipedia.org/wiki/Marco_Polo",
  maxHp: 1090,
  atk: 90,
  def: 65,
  agility: 70,
...
const medusa: ServantDefinition = {
  ...
  className: 'Rider',
  trueName: 'Medusa',
  wikiUrl: "https://en.wikipedia.org/wiki/Medusa",
  maxHp: 1050,
  atk: 105,
  def: 58,
  agility: 78,
...
const noah: ServantDefinition = {
  ...
  className: 'Rider',
  trueName: 'Noah',
  wikiUrl: "https://en.wikipedia.org/wiki/Noah",
  maxHp: 1450,
  atk: 90,
  def: 80,
  agility: 40,
...
const ozymandias: ServantDefinition = {
  ...
  className: 'Rider',
  trueName: 'Rameses II',
  wikiUrl: "https://en.wikipedia.org/wiki/Ramesses_II",
  maxHp: 1150,
  atk: 120,
  def: 62,
  agility: 55,
...
const quetzalcoatl: ServantDefinition = {
  ...
  wikiUrl: "https://en.wikipedia.org/wiki/Quetzalcoatl",
  maxHp: 1300,
  atk: 115,
  def: 65,
  agility: 65,
...
const astolfo: ServantDefinition = {
  ...
  className: 'Rider',
  trueName: 'Astolfo',
  wikiUrl: "https://en.wikipedia.org/wiki/Astolfo",
  maxHp: 1150,
  atk: 95,
  def: 55,
  agility: 90,
...
const drake: ServantDefinition = {
  ...
  wikiUrl: "https://en.wikipedia.org/wiki/Francis_Drake",
  maxHp: 1150,
  atk: 112,
  def: 58,
  agility: 68,
