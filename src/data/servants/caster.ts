...
const medea: ServantDefinition = {
  ...
  className: 'Caster',
  trueName: 'Medea',
  wikiUrl: "https://en.wikipedia.org/wiki/Medea",
  maxHp: 1015,
  atk: 116,
  def: 61,
  agility: 55,
...
const circe: ServantDefinition = {
  ...
  className: 'Caster',
  trueName: 'Circe',
  wikiUrl: "https://en.wikipedia.org/wiki/Circe",
  maxHp: 1025,
  atk: 113,
  def: 59,
  agility: 55,
...
const merlin: ServantDefinition = {
  ...
  className: 'Caster',
  trueName: 'Merlin',
  wikiUrl: "https://en.wikipedia.org/wiki/Merlin",
  maxHp: 1050,
  atk: 108,
  def: 65,
  agility: 55,
...
const nostradamus: ServantDefinition = {
  ...
  wikiUrl: "https://en.wikipedia.org/wiki/Nostradamus",
  maxHp: 975,
  atk: 106,
  def: 56,
  agility: 50,
...
const gillesDeRais: ServantDefinition = {
  ...
  wikiUrl: "https://en.wikipedia.org/wiki/Gilles_de_Rais",
  maxHp: 975,
  atk: 111,
  def: 59,
  agility: 50,
...
const solomon: ServantDefinition = {
  ...
  className: 'Caster',
  trueName: 'Solomon',
  wikiUrl: "https://en.wikipedia.org/wiki/Solomon",
  maxHp: 1300,
  atk: 120,
  def: 65,
  agility: 60,
...
const tamamo: ServantDefinition = {
  ...
  wikiUrl: "https://en.wikipedia.org/wiki/Tamamo-no-Mae",
  maxHp: 1100,
  atk: 103,
  def: 55,
  agility: 62,
...
const scathachSkadi: ServantDefinition = {
  ...
  wikiUrl: "https://en.wikipedia.org/wiki/Ska%C3%B0i",
  maxHp: 1200,
  atk: 105,
  def: 60,
  agility: 80,
...
const chenGong: ServantDefinition = {
  ...
  className: 'Caster',
  trueName: 'Chen Gong',
  wikiUrl: "https://en.wikipedia.org/wiki/Chen_Gong",
  maxHp: 900,
  atk: 82,
  def: 48,
  agility: 55,
...
const anastasia: ServantDefinition = {
  ...
  wikiUrl: "https://en.wikipedia.org/wiki/Grand_Duchess_Anastasia_Nikolaevna_of_Russia",
  maxHp: 1180,
  atk: 96,
  def: 62,
  agility: 62,
