...
const hassan: ServantDefinition = {
  ...
  wikiUrl: "https://en.wikipedia.org/wiki/Hasan-i_Sabbah",
  maxHp: 945,
  atk: 110,
  def: 54,
  agility: 90,
...
const theRipper: ServantDefinition = {
  ...
  wikiUrl: "https://en.wikipedia.org/wiki/Jack_the_Ripper",
  maxHp: 915,
  atk: 120,
  def: 49,
  agility: 95,
...
const semiramis: ServantDefinition = {
  ...
  className: 'Assassin',
  trueName: 'Semiramis',
  wikiUrl: "https://en.wikipedia.org/wiki/Semiramis",
  maxHp: 1025,
  atk: 95,
  def: 59,
  agility: 70,
...
const sasakiKojiro: ServantDefinition = {
  ...
  wikiUrl: "https://en.wikipedia.org/wiki/Sasaki_Kojir%C5%8D",
  maxHp: 1010,
  atk: 112,
  def: 58,
  agility: 100,
...
const tezcatlipoca: ServantDefinition = {
  ...
  wikiUrl: "https://en.wikipedia.org/wiki/Tezcatlipoca",
  maxHp: 1000,
  atk: 119,
  def: 60,
  agility: 85,
