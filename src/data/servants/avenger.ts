...
const kama: ServantDefinition = {
  ...
  className: 'Avenger',
  trueName: 'Kama',
  wikiUrl: "https://en.wikipedia.org/wiki/Kamadeva",
  maxHp: 1100,
  atk: 113,
  def: 55,
  agility: 70,
...
const nobunaga: ServantDefinition = {
  ...
  wikiUrl: "https://en.wikipedia.org/wiki/Oda_Nobunaga",
  maxHp: 1050,
  atk: 122,
  def: 58,
  agility: 62,
...
const edmondDantes: ServantDefinition = {
  ...
  wikiUrl: "https://en.wikipedia.org/wiki/Edmond_Dant%C3%A8s",
  maxHp: 1100,
  atk: 120,
  def: 60,
  agility: 58,
...
const jeanneAlter: ServantDefinition = {
  ...
  wikiUrl: "https://en.wikipedia.org/wiki/Joan_of_Arc",
  maxHp: 1250,
  atk: 125,
  def: 62,
  agility: 60,
...
const kagekiyo: ServantDefinition = {
  ...
  wikiUrl: "https://en.wikipedia.org/wiki/Taira_no_Kagekiyo",
  maxHp: 1050,
  atk: 95,
  def: 58,
  agility: 55,
...
const johnLackland: ServantDefinition = {
  ...
  wikiUrl: "https://en.wikipedia.org/wiki/John,_King_of_England",
  maxHp: 1470,
  atk: 85,
  def: 68,
  agility: 48,
