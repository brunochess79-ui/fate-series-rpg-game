...
const heracles: ServantDefinition = {
  ...
  className: 'Berserker',
  trueName: 'Heracles',
  wikiUrl: "https://en.wikipedia.org/wiki/Heracles",
  maxHp: 1375,
  atk: 125,
  def: 40,
  agility: 48,
...
const lancelot: ServantDefinition = {
  ...
  wikiUrl: "https://en.wikipedia.org/wiki/Lancelot",
  maxHp: 1430,
  atk: 116,
  def: 53,
  agility: 73,
...
const spartacus: ServantDefinition = {
  ...
  className: 'Berserker',
  trueName: 'Spartacus',
  wikiUrl: "https://en.wikipedia.org/wiki/Spartacus",
  maxHp: 1360,
  atk: 109,
  def: 58,
  agility: 68,
...
const morganLeFay: ServantDefinition = {
  ...
  wikiUrl: "https://en.wikipedia.org/wiki/Morgan_le_Fay",
  maxHp: 1500,
  atk: 122,
  def: 60,
  agility: 55,
...
const arjunaAlter: ServantDefinition = {
  ...
  className: 'Berserker',
  trueName: 'Arjuna',
  wikiUrl: "https://en.wikipedia.org/wiki/Arjuna",
  maxHp: 1400,
  atk: 130,
  def: 62,
  agility: 58,
...
const cuChulainnAlter: ServantDefinition = {
  ...
  wikiUrl: "https://en.wikipedia.org/wiki/C%C3%BA_Chulainn",
  maxHp: 1350,
  atk: 132,
  def: 55,
  agility: 62,
...
const hijikata: ServantDefinition = {
  ...
  wikiUrl: "https://en.wikipedia.org/wiki/Hijikata_Toshiz%C5%8D",
  maxHp: 1250,
  atk: 118,
  def: 60,
  agility: 62,
...
const vladIII: ServantDefinition = {
  ...
  className: 'Berserker',
  trueName: 'Vlad III',
  wikiUrl: "https://en.wikipedia.org/wiki/Vlad_the_Impaler",
  maxHp: 1500,
  atk: 125,
  def: 68,
  agility: 50,
...
const sakataKintoki: ServantDefinition = {
  ...
  wikiUrl: "https://en.wikipedia.org/wiki/Kintar%C5%8D",
  maxHp: 1300,
  atk: 134,
  def: 38,
  agility: 55,
