...
const diarmuid: ServantDefinition = {
  ...
  wikiUrl: "https://en.wikipedia.org/wiki/Diarmuid_Ua_Duibhne",
  maxHp: 1080,
  atk: 112,
  def: 65,
  agility: 95,
...
const achilles: ServantDefinition = {
  ...
  className: 'Lancer',
  trueName: 'Achilles',
  wikiUrl: "https://en.wikipedia.org/wiki/Achilles",
  maxHp: 1240,
  atk: 119,
  def: 73,
  agility: 75,
...
const karna: ServantDefinition = {
  ...
  className: 'Lancer',
  trueName: 'Karna',
  wikiUrl: "https://en.wikipedia.org/wiki/Karna",
  maxHp: 1310,
  atk: 109,
  def: 93,
  agility: 60,
...
const romulusQuirinus: ServantDefinition = {
  ...
  className: 'Lancer',
  trueName: 'Romulus',
  wikiUrl: "https://en.wikipedia.org/wiki/Romulus",
  maxHp: 1250,
  atk: 118,
  def: 68,
  agility: 60,
...
const enkidu: ServantDefinition = {
  ...
  className: 'Lancer',
  trueName: 'Enkidu',
  wikiUrl: "https://en.wikipedia.org/wiki/Enkidu",
  maxHp: 1300,
  atk: 105,
  def: 70,
  agility: 55,
...
const scathach: ServantDefinition = {
  ...
  className: 'Lancer',
  trueName: 'Scáthach',
  wikiUrl: "https://en.wikipedia.org/wiki/Sc%C3%A1thach",
  maxHp: 1350,
  atk: 125,
  def: 70,
  agility: 70,
...
const ereshkigal: ServantDefinition = {
  ...
  className: 'Lancer',
  trueName: 'Ereshkigal',
  wikiUrl: "https://en.wikipedia.org/wiki/Ereshkigal",
  maxHp: 1200,
  atk: 112,
  def: 65,
  agility: 55,
